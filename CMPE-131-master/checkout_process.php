...
if (isset($_SESSION["uid"])) {
    ...
    if(mysqli_query($con,$sql)){
        ...
        while($i<=$total_count){
			...
			$sqm = "INSERT INTO `order_products`(`order_pro_id`,`order_id`,`product_id`,`qty`,`amt`) VALUES (NULL, '$order_id','$prod_id','$prod_qty','$sub_total');";
			$sqm .= "INSERT INTO `orders` (`order_id`, `user_id`, `product_id`, `qty`, `p_status`, `o_id`) VALUES ('$order_id', '$user_id', '$prod_id','$prod_qty','pending', NULL);";
			$sqm .= "DELETE from cart where user_id=$user_id;)";
			$insert_result = $con->multi_query($sqm);

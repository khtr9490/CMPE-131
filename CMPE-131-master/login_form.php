								...
								<form onsubmit="return false" id="login" class="login100-form ">
                                    ...
                                    <div class="form-group">
                                       <label for="email">Username</label>
                                        <input class="input input-borders" type="username" name="username" placeholder="username" id="username" required>
                                    </div>
                                    ...
                                    <div style="form-group">
									   ...
									   <div class="panel-footer" hidden><div class="alert alert-danger"><h4 id="e_msg"></h4></div></div>
                                    </div>
                                </div>
								</form>
					</div>
